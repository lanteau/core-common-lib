...
#define DBGMCU_SETTINGS (DBGMCU_SLEEP|DBGMCU_STOP|DBGMCU_STANDBY|DBGMCU_IWDG_STOP|DBGMCU_WWDG_STOP)
#else
#define USE_ONLY_PANIC // Define to remove all Logging and only have Panic
#define DBGMCU_SETTINGS (DBGMCU_IWDG_STOP|DBGMCU_WWDG_STOP)
#endif
